<?php 
 ...
 if(isset($_GET['GetName']))
 {
	 ...
	 $text ="<script>localStorage.removeItem('selectedSeats');
		...
		<div class="row ipad-width2">
			...
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img">
					...
					<div class="movie-btn">	
						<div class="btn-transform transform-vertical mb-3">
							<div><a href="#" class="item item-1 redbtn"> <i class="ion-play"></i> Movie Time</a></div>
							<div><a class="item item-2 redbtn fancybox-media hvr-grow "><i class="fa fa-clock-o"><span class="p-3"><?php echo date('h:i:s a', strtotime($time)) ?></i></span></a></div>
						</div>
						<div class="btn-transform transform-vertical">
							<div><a href="Seats.php?GetName=<?php echo $MovieName; ?>" class="item item-1 yellowbtn"> <i class="ion-card"></i> Buy ticket</a></div>
							<div><a href="Seats.php?GetName=<?php echo $MovieName; ?>" class="item item-2 yellowbtn"><i class="ion-card"></i>Book Ticket</a></div>
						</div>
					</div>
				</div>
			</div>
