			...
			<div class="col-md-12" >
				<div class="hero-ct">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span> Upcomming</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="flex-wrap-movielist mv-grid-fw">
					...
					?>
						<div class="movie-item-style-2 movie-item-style-1 d-flex justify-content-center align-items-center">
							...
							<div class="hvr-inner">
	            				<a  href="moviescomingsingle.php?GetName=<?php echo $MovieName; ?>"> Read more <i class="ion-android-arrow-dropright"></i> </a>
	            			</div>
